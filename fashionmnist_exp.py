...
def parse_args():
    ...
    args.model_name = 'FashionMNIST_{}_{}_bs_{}_olr_{}_ilr_{}_eta_{}_noiser_{}_q_{}_ite_{}'.format(args.alg, 
...
def get_data_loaders(args):
    ...
    dataset = datasets.FashionMNIST(root=args.data_path, train=True, download=True,
    ...
    test_loader = torch.utils.data.DataLoader(datasets.FashionMNIST(root=args.data_path, train=False,
